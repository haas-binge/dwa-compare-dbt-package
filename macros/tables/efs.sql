{%- macro efs(sts_sats, link_hashkey, link_name, driving_key, secondary_fks, ledts_alias='ledts', src_edts=none, add_is_current_flag=false) -%}
...
{%- macro snowflake__efs(sts_sats, link_hashkey, link_name, driving_key, secondary_fks, ledts_alias='ledts', src_edts=none, add_is_current_flag=false) -%}
