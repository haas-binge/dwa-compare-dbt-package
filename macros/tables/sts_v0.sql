{%- macro sts_v0(tracked_hashkey, stage_source_model=none, load_type='full', src_ldts=none, src_rsrc=none, src_edts=none,edts_hashkey=none) -%}
...
{%- macro snowflake__sts_v0(tracked_hashkey, stage_source_model, load_type, src_ldts, src_rsrc, src_edts, edts_hashkey) -%}
